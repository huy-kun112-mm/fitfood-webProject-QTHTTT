...
.add-to-cart.is-disabled, .popup-add-cart.is-disabled { opacity: .45; pointer-events: none; cursor: not-allowed; }
...
(function () {
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', function () { render(); bind(); });
    } else {
