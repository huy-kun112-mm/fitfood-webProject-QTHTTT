...
<head>
    ...
    <meta name="csrf-token" content="nOLTwBLYfcvYPvZyVJLsOkrwAPLaFP0BkRPORWlC">
    <meta name="lang" content="vi">

    <title>Gói FIT 3</title>
        <meta name="description" content="Gói TRƯA - TỐI. *Best Seller, Thích hợp cho dân văn phòng">
    
    <link rel="icon" href="/favicon.ico">
    <link rel="canonical" href="https://fitfood.vn/san-pham/fit3" />
    <link rel="alternate" hreflang="vi" href="https://fitfood.vn/san-pham/fit3" />
    ...
    <meta property="og:image:height" content="1365" />
            ...
            <script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"Product","name":"Gói FIT 3","description":"Gói TRƯA - TỐI. *Best Seller, Thích hợp cho dân văn phòng","image":"https:\/\/fitfood.vn\/img\/original\/images\/fit3-2-15831416118117.jpg","offers":{"@type":"Offer","priceCurrency":"VND","price":650000}}</script>
...
<body data-page="package" data-device="desktop"
    class="" data-url="https://fitfood.vn/san-pham/fit3"
    data-lang="vi">
            ...
            <div class="box-info fix-span order mb-5">
                <div class="row">
                    <div class="col-md-4 mb-3">
                                                    <div class="slides">
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-fit3-healthy-2-17521258413949.jpg" alt="Gói FIT 3 0" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-fit3-healthy-5-17521258412531.jpg" alt="Gói FIT 3 1" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-fit3-healthy-6-17521258411989.jpg" alt="Gói FIT 3 2" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-fit3-healthy-4-17521258412981.jpg" alt="Gói FIT 3 3" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-fit3-healthy-1-17521258413429.jpg" alt="Gói FIT 3 4" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-fit3-healthy-3-17521258414396.jpg" alt="Gói FIT 3 5" /></div>
    </div>
                                            </div>
                    <div class="col-md-8 mb-3">
                        <div class="d-flex flex-column flex-lg-row justify-content-between">
                            <h1 class="title">Gói FIT 3</h1>
                            <p id="p-price" class="price">650,000đ</p>
                        </div>
                        <p class="note note-ex"></p>
                        <p><p><strong>G&oacute;i 2 bữa TRƯA - TỐI (Best Seller)</strong></p>
...
<p>- Calories dao động từ 1100 - 1200 Kcal mỗi ng&agrave;y</p>

<p>- K&egrave;m tinh bột phức, &iacute;t đường, đảm bảo ko bột ngọt, nhiều rau củ v&agrave; chất đạm</p>

<p><em>* Th&iacute;ch hợp cho d&acirc;n văn ph&ograve;ng bận rộn, vừa giảm c&acirc;n, vừa tiết kiệm thời gian</em></p></p>
                            ...
                            <input type="hidden" name="package" value="fit3">
                                                    ...
                                                    <img style="max-width: 100%" class="menu-photo" src="https://fitfood.vn/img/original/menus/menu-healthy-fitfood-17768262490214.jpg" alt="Gói FIT 3"/>
                                            </div>
                </div>
            </div>
                    </div>
