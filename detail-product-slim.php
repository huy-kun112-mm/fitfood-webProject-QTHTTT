...
<head>
    ...
    <title>Gói SLIM</title>
        <meta name="description" content="Gói TRƯA -- TỐI. Không tinh bột, nhân đôi rau">
    
    <link rel="icon" href="/favicon.ico">
    <link rel="canonical" href="https://fitfood.vn/san-pham/slim" />
    <link rel="alternate" hreflang="vi" href="https://fitfood.vn/san-pham/slim" />
    ...
    <meta property="og:image:height" content="1365" />
            ...
            <script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"Product","name":"Gói SLIM","description":"Gói TRƯA -- TỐI. Không tinh bột, nhân đôi rau","image":"https:\/\/fitfood.vn\/img\/original\/no-image.png","offers":{"@type":"Offer","priceCurrency":"VND","price":600000}}</script>
...
<body data-page="package" data-device="desktop"
    class="" data-url="https://fitfood.vn/san-pham/slim"
    data-lang="vi">
            ...
            <div class="box-info fix-span order mb-5">
                <div class="row">
                    <div class="col-md-4 mb-3">
                                                    <div class="slides">
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-slim-healthy-1-17521260981757.jpg" alt="Gói SLIM 0" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-slim-healthy-6-17521260982381.jpg" alt="Gói SLIM 1" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-slim-healthy-7-17521260982843.jpg" alt="Gói SLIM 2" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-slim-healthy-5-17521260982087.jpg" alt="Gói SLIM 3" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-slim-healthy-3-17521260981391.jpg" alt="Gói SLIM 4" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-slim-healthy-2-1752126098108.jpg" alt="Gói SLIM 5" /></div>
    </div>
                                            </div>
                    <div class="col-md-8 mb-3">
                        <div class="d-flex flex-column flex-lg-row justify-content-between">
                            <h1 class="title">Gói SLIM</h1>
                            <p id="p-price" class="price">600,000đ</p>
                        </div>
                        <p class="note note-ex"></p>
                        <p><p>G&oacute;i SLIM gồm 2 bữa TRƯA - TỐI&nbsp;<strong>(Hạn chế tinh bột, GẤP Đ&Ocirc;I rau)</strong></p>

<p>- Sử dụng thực đơn 2&nbsp;bữa TRƯA -TỐI&nbsp;tại trang fitfood.vn/menu.</p>

<p>- Giao 02&nbsp;phần ăn tận nơi mỗi ng&agrave;y, từ thứ 2 đến thứ 6. (Nếu kh&aacute;ch đổi qua m&oacute;n s&aacute;ng, vui l&ograve;ng c&acirc;n nhắc&nbsp;v&igrave; định lượng m&oacute;n s&aacute;ng sẽ &iacute;t hơn m&oacute;n trưa v&agrave; tối.&nbsp;Vui l&ograve;ng li&ecirc;n hệ Fanpage Fitfood VN để được tư vấn r&otilde; hơn.)</p>

<p>- Calories dao động từ 300 - 400 Kcal / phần ăn</p>

<p>- Lưu &yacute; g&oacute;i SLIM n&agrave;y HẠN CHẾ tinh bột, &iacute;t đường, gấp đ&ocirc;i lượng rau củ v&agrave; giảm lượng đạm (Li&ecirc;n hệ admin để biết r&otilde; th&ocirc;ng tin)</p>

<p><em>* Th&iacute;ch hợp cho c&aacute;c bạn siết c&acirc;n, th&iacute;ch ăn nhiều rau, giảm c&acirc;n nhanh, vừa tiết kiệm thời gian</em></p></p>
                                        ...
                                        <input class="form-check-input" type="radio" name="order_type" id="orderRadios1" value="week" checked data-price="600,000">
                                        <label class="form-check-label" for="orderRadios1">Gói Tuần - 5 ngày</label>
                                    </div>
                                                                                                <div class="form-check input-radio">
                                    <input class="form-check-input" type="radio" name="order_type" id="orderRadios2" value="month" data-price="2,160,000">
                                    <label class="form-check-label" for="orderRadios2">Gói Tháng (4 tuần)</label>
                                </div>
                                                            </div>
                            
                            <input type="hidden" name="package" value="slim">
                                                    ...
                                                    <img style="max-width: 100%" class="menu-photo" src="https://fitfood.vn/img/original/menus/menu-healthy-fitfood-17768262490214.jpg" alt="Gói SLIM"/>
                                            </div>
                </div>
            </div>
                    </div>
