...
<head>
    ...
    <title>Gói MEAT</title>
        <meta name="description" content="Gói TRƯA - TỐI. Dành cho dân Gym. Nhiều đạm và rau củ.">
    
    <link rel="icon" href="/favicon.ico">
    <link rel="canonical" href="https://fitfood.vn/san-pham/meat" />
    <link rel="alternate" hreflang="vi" href="https://fitfood.vn/san-pham/meat" />
    ...
    <meta property="og:image:height" content="1365" />
            ...
            <script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"Product","name":"Gói MEAT","description":"Gói TRƯA - TỐI. Dành cho dân Gym. Nhiều đạm và rau củ.","image":"https:\/\/fitfood.vn\/img\/original\/images\/meat-15814245934955.jpg","offers":{"@type":"Offer","priceCurrency":"VND","price":950000}}</script>
...
<body data-page="package" data-device="desktop"
    class="" data-url="https://fitfood.vn/san-pham/meat"
    data-lang="vi">
            ...
            <div class="box-info fix-span order mb-5">
                <div class="row">
                    <div class="col-md-4 mb-3">
                                                    <div class="slides">
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-meat-healthy-17521260514909.jpg" alt="Gói MEAT 0" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-meat-healthy-5-17521260516227.jpg" alt="Gói MEAT 1" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-meat-healthy-6-17557566563233.jpg" alt="Gói MEAT 2" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-meat-healthy-4-17521260516724.jpg" alt="Gói MEAT 3" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-meat-healthy-1-17521260515794.jpg" alt="Gói MEAT 4" /></div>
            <div><img src="https://fitfood.vn/static/sizes/800x600-fitfood-goi-meat-healthy-3-17521260514577.jpg" alt="Gói MEAT 5" /></div>
    </div>
                                            </div>
                    <div class="col-md-8 mb-3">
                        <div class="d-flex flex-column flex-lg-row justify-content-between">
                            <h1 class="title">Gói MEAT</h1>
                            <p id="p-price" class="price">950,000đ</p>
                        </div>
                        <p class="note note-ex"></p>
                        <p><p>G&oacute;i 2 bữa TRƯA - TỐI (gấp 1.5 lượng thịt)</p>

<p>- Sử dụng thực đơn 2&nbsp;bữa TRƯA -TỐI&nbsp;tại trang fitfood.vn/menu.</p>

<p>- C&aacute;c m&oacute;n đều được nh&acirc;n 1.5 lần định lượng thịt v&agrave; rau củ</p>

<p>- Giao 02&nbsp;phần ăn tận nơi mỗi ng&agrave;y, từ thứ 2 đến thứ 6.</p>

<p>- Calories dao động khỏang 1700-2000Kcal mỗi ng&agrave;y</p>

<p>- K&egrave;m tinh bột phức, &iacute;t đường, đảm bảo ko bột ngọt, nhiều rau củ v&agrave; chất đạm</p>

<p><em>* Th&iacute;ch hợp cho c&aacute;c bạn đang tập Gym, Fitness cường độ cao hoặc cần Bulking</em></p></p>
                                        ...
                                        <input class="form-check-input" type="radio" name="order_type" id="orderRadios1" value="week" checked data-price="950,000">
                                        <label class="form-check-label" for="orderRadios1">Gói Tuần - 5 ngày</label>
                                    </div>
                                                                                                <div class="form-check input-radio">
                                    <input class="form-check-input" type="radio" name="order_type" id="orderRadios2" value="month" data-price="3,420,000">
                                    <label class="form-check-label" for="orderRadios2">Gói Tháng (4 tuần)</label>
                                </div>
                                                            </div>
                            
                            <input type="hidden" name="package" value="meat">
                                                    ...
                                                    <img style="max-width: 100%" class="menu-photo" src="https://fitfood.vn/img/original/menus/menu-healthy-fitfood-17768262490214.jpg" alt="Gói MEAT"/>
                                            </div>
                </div>
            </div>
                    </div>
